...
"gadgets.osDataUri" : "http://%host%%webprefix%social/rpc",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%%webprefix%gadgets/proxy?refresh=%refresh%&url=%url%",
    "jsonProxyUrl" : "http://%host%%webprefix%gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
  ...
  "opensocial-0.8" : {
    ...
    "path" : "http://%host%%webprefix%social",
    "domain" : "shindig",
    "enableCaja" : false,
    "supportedFields" : {
